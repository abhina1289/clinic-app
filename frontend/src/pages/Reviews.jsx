    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-blue-600 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className={`text-5xl font-bold mb-4 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
            NAAVIKA
          </h1>
          <p className={`text-2xl mb-2 transition-all duration-1000 delay-200 transform ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
            Hearing Health Clinic
          </p>
          <p className={`text-lg text-teal-100 transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
            ...
            {reviews.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  index === currentReview ? 'w-8 bg-teal-600' : 'w-2 bg-gray-300'
                }`}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviews.map((review, index) => {
            ...
            return (
              ...
              >
                <div className="flex items-center mb-4">
                  <div className={`w-12 h-12 rounded-full ${avatarColors[index % avatarColors.length]} flex items-center justify-center text-white font-bold text-lg mr-3 flex-shrink-0`}>
      ...
      <div className="bg-gradient-to-r from-teal-600 to-blue-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8 text-teal-100">
            Join thousands of satisfied patients who trust Naavika for their hearing care
          </p>

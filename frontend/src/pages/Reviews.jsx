...
export default function Reviews() {
  ...
  const reviews = [
    {
      id: 1,
      name: "Shruthi shivdas",
      location: "Banglore",
      rating: 5,
      date: "January 2026",
      text: "Totally happy with the services my dad received . Abhishek is absolutely professional since my dad has parkinsons he did home visists and made sure dad was comfortable throughout my dad's hearing is at its best now Super impressive",
      service: "Hearing Aid Fitting",
    },
    {
      id: 2,
      name: "Ramaswami Ganesan",
      location: "Chennai",
      rating: 5,
      date: "2 years ago",
      text: "Since six years , no audiologist could set right my hearing aid...STARKEY model. Cheif doctor in the clinic Naavika Hearing Clinic, JP Nagar, Banglore, had resolved my hearing problems using the above hearing aid. Doctor Sab!! i hear much much better now. I owe a lot to you ",
    ...
    },
    {
      ...
      rating: 5,
      date: "a year ago",
      text: "I've been wearing hearing aids for years , but i've never had this level of care before. The clinc doesn't just fit you and send you off- they offer continous check-ups and adjustments, ensuring my devices are always performing at their best.",
    ...
    },
    {
      ...
      rating: 5,
      date: "2 years ago",
      text: "I took my mom to the clinic . They have qualified staff. they ptovide thorough info and suggest the machine after detailed test. O verall , their servbices are great .",
    ...
    },
    {
      ...
      rating: 5,
      date: "3 months ago",
      text: "From the receptionist to the doctor, everyone was extremely polite and accommodating. The staff made us feel comfortable and provided professional, friendly service throughout my visit. Highly reccommend this clinic for anyone seeking hearing care",
      service: "Hearing tests",
    },
    {
      id: 6,
      name: "Vijaya Chari ",
      ...
      rating: 5,
      date: "2 years ago",
      text: "Best service & Abhishek the audiologist is the best person  who knows everything about his work breifs very nicely & makes others to understand & got good knwoledge",
      service: "Hearing aid fitting",
    },
  ];
